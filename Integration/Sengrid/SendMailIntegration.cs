...
namespace appPolnice.Integration.Sengrid
{
    public class SendMailIntegration
    {
        ...
        private string From = "diana_torres6@usmp.pe"; // settings\sender authentification
        ...
        private async Task SendMailSengridRest(string correoDestino,string userDestino,string titulo, string contenido){
            ...
            jsonObject.Append("\"email\": \"diana_torres6@usmp.pe\","); 
            jsonObject.Append("\"name\": \"Diana \"");
            jsonObject.Append("},");
            ...
            jsonObject.Append("\"name\": \"Diana T\" ");
            jsonObject.Append("}");
            jsonObject.Append("],");
